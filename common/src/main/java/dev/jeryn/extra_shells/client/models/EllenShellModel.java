...
public class EllenShellModel extends ShellModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition portal = partdefinition.addOrReplaceChild("portal", CubeListBuilder.create().texOffs(36, 117).addBox(-8.0F, -32.0F, -9.0F, 16.0F, 30.0F, 8.0F, new CubeDeformation(-0.05F)), PartPose.offset(0.0F, 24.0F, 0.0F));
